/*
 * IRremote - Optimized for memory
 */

#ifndef IRremoteint_h
#define IRremoteint_h

// Memory optimization - only decode NEC protocol and disable sending
#define IR_DECODE_NEC_ONLY
#define IR_DISABLE_SEND
...
// Only include other protocol constants if not in NEC-only mode
